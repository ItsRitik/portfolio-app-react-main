      ...
      >
        <TimelineItem>
          ...
          <TimelineContent sx={{ marginLeft: 1, paddingLeft: 1 }}>
            <div>
              <p className="text-xl text-selective-yellow-300">
                Pace University
              </p>
              <p className="text-sm text-selective-yellow-100">
                Master Of Science(Computer Science)
              </p>
              <p className="text-xs pb-1 text-mine-shaft-100 font-bold">
                SEPTEMBER 2023 - MAY 2025
              </p>
              <p className="text-sm pb-1 text-selective-yellow-500 font-bold">
                GPA: 3.9
              </p>
              <div>
                Courses:
