    ...
    <div name="home" className="home w-full h-screen ">
      <div className="max-w-[100%] md:max-w-[100%] lg:max-w-[60%] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-md sm:text-xl  font-bold text-white-100">
          Currently Persuing Masters's Degree in{" "}
        ...
        <p className="text-sm sm:text-lg text-white-100  py-2 sm:py-4">
          ...
          , demonstrating my expertise in the field of{" "}
          <span className="text-xl sm:text-2xl text-selective-yellow-300">
        ...
        <p className="text-sm sm:text-lg text-white-100 ">
          I am excited to continue my professional journey in the software
          engineering field and am{" "}
          <span className="text-xl sm:text-2xl text-selective-yellow-300">
            looking for an internship in Spring'24 & full-time Software Engineer
            role
          </span>{" "}
          that will allow me to apply my strong development skills while gaining
          the{" "}
          <span className="text-xl sm:text-2xl text-selective-yellow-300">
            mentorship
          </span>{" "}
        ...
        <div>
          <a
            href="https://drive.google.com/file/d/1MAdNWgt4fplTfIEynlZwy4HlPCnydWKD/view?usp=sharing"
            target="_blank"
          >
